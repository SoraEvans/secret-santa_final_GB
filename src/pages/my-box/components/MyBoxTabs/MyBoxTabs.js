...
const MyBoxTabs = () => {
	...
	return (
		<>
			...
			<TabBody>
				{activeIdx === 1 && (
					<MyCard santaId={santaId} setActiveIdx={setActiveIdx} id={cardId} />
				)}
			</TabBody>
			<TabBody>
				{activeIdx === 2 && (
					<WardCard wardId={wardId} setActiveIdx={setActiveIdx} id={cardId} />
				)}
			</TabBody>
			<TabBody>
				{activeIdx === 3 && <MyCardCreate isAdmin={isAdmin} userData={userData} />}
			</TabBody>
			<TabBody>
				{activeIdx === 4 && (
					<DrawResult setActiveIdx={setActiveIdx} userData={userData} />
				)}
			</TabBody>
		</>
	);
